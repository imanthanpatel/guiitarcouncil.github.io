...
const DroneWorkshopContent: React.FC = () => {
  ...
  const courseContent = [
    {
      ...
      description:
        "Introduction to fundamental principles of flight and aviation.",
      details: [
  ...
  const workshopBenefits = [
    {
      text: "Certificate to be Issued by Gujarat University, GUSEC and IIES",
      icon: (
        <i
          className="fas fa-award text-blue-400"
          style={{ fontSize: "70px" }}
        />
      ),
    },
    {
      ...
      icon: (
        <i
          className="fas fa-chalkboard-teacher text-blue-400"
          style={{ fontSize: "70px" }}
        />
      ),
    },
    {
      ...
      icon: (
        <i className="fas fa-book text-blue-400" style={{ fontSize: "70px" }} />
      ),
    },
    {
      ...
      icon: (
        <i
          className="fas fa-users text-blue-400"
          style={{ fontSize: "70px" }}
        />
      ),
    },
    {
      ...
      icon: (
        <i
          className="fas fa-tools text-blue-400"
          style={{ fontSize: "70px" }}
        />
      ),
    },
        ...
        {courseContent.map((section) => (
          ...
          >
            ...
            <button
              ...
              className="w-full flex justify-between items-center p-6 text-left bg-gray-200 hover:bg-gray-400 transition-colors duration-100"
            >
              <div>
      ...
      <section className="max-w-6xl mx-auto mt-12">
        ...
        <div className="flex justify-center gap-6 flex-wrap md:flex-nowrap">
          {workshopBenefits.map((benefit, index) => (
            <div
              key={index}
              className="bg-gray-800 p-6 rounded-lg shadow-lg w-64 text-center flex flex-col items-center transform transition duration-300 hover:scale-105 hover:bg-gray-700"
            >
              {benefit.icon}
